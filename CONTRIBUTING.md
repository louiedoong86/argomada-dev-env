...
1. Open in a new tab https://github.com/argomada/argomada-dev-env
...
```
cd ~/Downloads
git clone git@github.com:username/argomada-dev-env.git
cd argomada-dev-env
```
...
```
git remote add upstream git@github.com:argomada/argomada-dev-env.git
```
